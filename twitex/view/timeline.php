...
<head>
    ...
    <header>
        ...
        <body>
        <h1><?=$_SESSION['login']?>'s Timeline</h1>
        ...
        <form action = "/twitex/handlePost" method = "POST">

            <input type="text" id="Post" id="input-2" name="message" placeholder="Type what you want to post" required minlength="1" maxlength="140" size="10">
        ...
        <div  id="Post">
        <table>
            <?php if($params['posts'] === null) echo "No posts in your timeline";
